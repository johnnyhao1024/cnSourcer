import { getCurrentSession, isAdminSession, loginUser, logoutUser, registerUser, renderSessionControls } from "./auth.js";
...
function renderAuthControls() {
    ...
    document.getElementById("siteLogoutBtn")?.addEventListener("click", () => {
        logoutUser();
        setNotice("");
        renderAuthControls();
    });
